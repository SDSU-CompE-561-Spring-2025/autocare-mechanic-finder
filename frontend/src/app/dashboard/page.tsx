...
export default function Dashboard() {
    return(
        <div>
            <div className="flex flex-col justify-center items-center h-screen w-screen bg-[url('/images/RoadSurface.jpg')] bg-cover bg-repeat bg-size-[30%] min-h-fit overflow-auto">
